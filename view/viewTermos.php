...
<html lang="en">
    <head>
        ...
        <script src="../assets/js/extratorTwitterTermos.js" language="javascript"></script>
    </head>
    <body>
		<?php
        ...
        <div class="container">
            ...
            <div id="modalAdicionar" class="modal fade">
                <div class="modal-header">
                    ...
                    <h3 id="modalContactHeader">Adicionar Termos de Busca</h3>
                </div>
                <div class="modal-body">
                	<form class="modal-form form-horizontal" id="termosBusca" method="post" action="../controller/contTermos.php?function=insert">
                        <fieldset>
                            <div class="modal-body">
                                <div id="aboutText">
                                        Termo:
